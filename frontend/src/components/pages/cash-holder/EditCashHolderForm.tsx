...
export default function UserEditForm({
  ...
  const onSubmit = async (data: UserFormValues) => {
    try {
      ...
      const res = await fetch(`${API_URL}/api/cash-holders/${userId}/`, {
        method: "PUT", // یا "PUT" بسته به API
        headers: {
      ...
      if (!res.ok) {
        ...
        notify("error", error?.detail || "بروزرسانی با خطا مواجه شد");
      }

      notify("success", "تنخواه با موفقیت بروزرسانی شد");
    } catch (err: any) {
